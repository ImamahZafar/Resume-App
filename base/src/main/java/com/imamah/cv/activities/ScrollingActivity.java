...
public class ScrollingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(R.drawable.profile3).into(profileImage);
        ...
        mViewPagerAdapter.addFragment(Achievement.newInstance(),"Achievements");
    ...
    private void setupTabIcons() {
        ...
        tabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                Objects.requireNonNull(tab.getIcon()).setColorFilter(Color.parseColor("#b0120a"), PorterDuff.Mode.SRC_IN);
            }
            @Override
